...
import { postUserRequest, putUserRequest, deleteUserRequest } from "../services/request";
...
export const Users = () => {
  ...
  const onSubmitForm = async (e) => {
    ...
    if (verifyInputs) {
      const res = await postUserRequest(formState, document.cookie.replace('token=', ''))
  ...
  const onEditData = (e) => {
    async function putData() {
      ...
      const res = await putUserRequest(data, document.cookie.replace('token=', ''))
      const toast = Swal.mixin({
        toast: true,
        position: 'top-end',
        showConfirmButton: false,
